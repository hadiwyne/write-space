...
.search-tabs { display: flex; gap: 0.5rem; margin-bottom: 1rem; background: var(--bg-primary); padding: 0.25rem; border-radius: var(--radius-md); border: 2px solid var(--border-light); flex-wrap: wrap; }
