-- CreateEnum
CREATE TYPE "ContentType" AS ENUM ('LATEX', 'MARKDOWN', 'HTML', 'WYSIWYG');
...
-- CreateIndex
CREATE INDEX "drafts_last_saved_at_idx" ON "drafts"("last_saved_at");
...
-- AddForeignKey
ALTER TABLE "drafts" ADD CONSTRAINT "drafts_previous_version_id_fkey" FOREIGN KEY ("previous_version_id") REFERENCES "drafts"("id") ON DELETE SET NULL ON UPDATE CASCADE;
